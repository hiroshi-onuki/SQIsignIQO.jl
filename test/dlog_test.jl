using Nemo
using KaniSQIsign
import KaniSQIsign.Level1: ec_dlog_power_of_2, ec_dlog_power_of_2_E0
...
n1, n2, n3, n4 = ec_dlog_power_of_2(xP, xQ, xPQ, P0, Q0, A, e)
n1, n2, n3, n4 = @time ec_dlog_power_of_2(xP, xQ, xPQ, P0, Q0, A, e)
...
n1, n2, n3, n4 = ec_dlog_power_of_2_E0(xP, xQ, xPQ, cdata)
n1, n2, n3, n4 = @time ec_dlog_power_of_2_E0(xP, xQ, xPQ, cdata)
n1P0 = mult(n1, P0, Proj1(A))
n2Q0 = mult(n2, Q0, Proj1(A))
n3P0 = mult(n3, P0, Proj1(A))
n4Q0 = mult(n4, Q0, Proj1(A))
